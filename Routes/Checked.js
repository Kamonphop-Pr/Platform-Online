        ...
        for(let pro in showCart){
            var product = "\
                ...
                database.RunQueryPromise(product,Sequelize.QueryTypes.SELECT, function (resproduct) {
                    ...
                    database.RunQueryPromise(Tran,Sequelize.QueryTypes.SELECT,(Bangkok)=>{
                        const TranP="SELECT * FROM TranshipProvince;"
                        database.RunQueryPromise(TranP,Sequelize.QueryTypes.SELECT,(Provin)=>{
                            const cost="SELECT * FROM Services;"
                            database.RunQueryPromise(cost,Sequelize.QueryTypes.SELECT,(servi)=>{
